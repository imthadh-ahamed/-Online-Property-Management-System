...
<!-- Right Side -->
        <div class="col-lg" style="background-color: #808080">
        	<div class="container">
        		<div class="row">
        			<div class="col-md-4 offset-md-4" style="padding-top: 250px;">
        				<div class="card">
        					<div class="card-body">
        					<h3 class="text-center"> View Property Details</h3>
								<div class="text-center">
									<p>
										<strong>Property Name:</strong> ${propName}
									</p>
									<p>
										<strong>Address:</strong> ${propAddress}
									</p>
									<p>
										<strong>Price:</strong> ${propPrice}
									</p>
									
									<p>
										<strong>Status:</strong> ${propStatus}
									</p>
									
									<a href="adminHome.jsp"><button type="submit" value="submit" class="btn btn-primary"> Back to Admin Home </button></a>
